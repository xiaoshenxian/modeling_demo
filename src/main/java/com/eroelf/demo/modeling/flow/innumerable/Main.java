...
//Here is an example for a whole INNUMERABLE working flow.
public class Main
{
	...
	// Entrance to an innumerable working flow.
	...
	public static void main(String[] args)
	{
		...
		InnumerableFlowHandler<ProductItem> flowHandler=new StrategyProductItemFlowHandler(requestInfo);
		...
		ItemGenerator<ProductItem> itemGenerator=new StrategyProductItemGenerator(flowHandler, filterHandler, requestInfo.verboseInfo || requestInfo.verboseLog);
